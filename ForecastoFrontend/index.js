...
function getData() {
  ...
  const url = `https://forecasto-production.up.railway.app/weather/forecastSummary?location=${city}`;
...
function getHourlyForecast() {
  ...
  fetch(
    `https://forecasto-production.up.railway.app/weather/hourlySummary?location=${cityName}`
  )
